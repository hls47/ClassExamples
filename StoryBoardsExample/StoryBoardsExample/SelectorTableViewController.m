...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if ([segue.identifier isEqualToString:@"puppy"]) {
        avc.imageName =@"puppy";
    }
    if ([segue.identifier isEqualToString:@"kitten"]) {
        avc.imageName =@"kitten";
    }
    if ([segue.identifier isEqualToString:@"penguin"]) {
        avc.imageName =@"penguin";
    }
